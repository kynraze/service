...
KYVE_GENESIS=https://raw.githubusercontent.com/enodex/service/main/testnet/kyve/genesis.json
KYVE_ADDRBOOK=https://raw.githubusercontent.com/enodex/service/main/testnet/kyve/addrbook.json
KYVE_DENOM=tkyve
KYVE_PORT=11
...
# Set peers and seeds
PEERS="664e06d2d6110c5ba93f8ecfee66f150bad981bf@kyve-testnet-peer.itrocket.net:443,2565b16987b8f7f9adb23d2f8c6ae110dad84823@170.64.174.214:11656"
...
sed -i -e "s/^minimum-gas-prices *=.*/minimum-gas-prices = \"0.001$KYVE_DENOM\"/" $HOME/$ORDOS_FOLDER/config/app.toml

$KYVE tendermint unsafe-reset-all --home $HOME/$KYVE_FOLDER --keep-addr-book

STATE_SYNC_RPC="https://test-kyve-rpc.enodex.lol:443"

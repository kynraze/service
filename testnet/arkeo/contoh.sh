...
ARKEO_ID=arkeo
ARKEO_FOLDER=.arkeo
ARKEO_VER=ab05b124336ace257baa2cac07f7d1bfeed9ac02
ARKEO_REPO=https://github.com/arkeonetwork/arkeo
...
echo -e "NODE COMMIT    : \033[38;2;4;204;255m$ARKEO_VER\e[0m"
...
rm -rf arkeo
git clone $ARKEO_REPO
cd arkeo
git checkout $ARKEO_VER

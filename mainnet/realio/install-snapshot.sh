...
REALIO_DENOM=ario
REALIO_PORT=10
REALIO_URL=https://snap.kynraze.com/realio/snapshot-latest.tar.lz4
...
echo -e "NODE VERSION   : \033[38;2;4;204;255m$REALIO_VER\e[0m"
echo -e "FOLDER         : \033[38;2;4;204;255m$REALIO_FOLDER\e[0m"
echo ""
...
curl -L $REALIO_URL | tar -Ilz4 -xf - -C $HOME/$REALIO_FOLDER

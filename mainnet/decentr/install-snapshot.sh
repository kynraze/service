...
echo "║  ╚═╝  ╚═╝   ╚═╝   ╚═╝  ╚═══╝╚═╝  ╚═╝╚═╝  ╚═╝╚══════╝╚══════╝  ║"
echo "╚═══════════════════════════════════════════════════════════════╝"
echo "Auto Installer For Decentr Network";
...
DECENTR_DENOM=udec
DECENTR_PORT=12
DECENTR_URL=https://snap.kynraze.com/decentr/snapshot-latest.tar.lz4
...
echo -e "NODE VERSION   : \033[38;2;4;204;255m$DECENTR_VER\e[0m"
echo -e "FOLDER         : \033[38;2;4;204;255m$DECENTR_FOLDER\e[0m"
echo ""
...
curl -L $DECENTR_URL | tar -Ilz4 -xf - -C $HOME/$DECENTR_FOLDER
